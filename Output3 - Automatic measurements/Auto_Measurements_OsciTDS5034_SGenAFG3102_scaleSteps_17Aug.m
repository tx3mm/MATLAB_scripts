% This script is used to record the results of different frequency, voltages and duty 
% cycle tests on the TJA1462A and TJA1442A transceivers,
% and the differential probe board under development.
% The instruments used are:
%    - Tektronix TDS5034B digital oscilloscope
...
fprintf(osciInterfaceObj, 'DATA:STOP 50000');
...
for dutyLoopIdx = 1:length(dutyValues)
    ...
    elseif dutyValues(dutyLoopIdx) == 80
       ...
       fprintf(osciInterfaceObj, 'HORizontal:POSition %d', horPos); 
        ...
        printf('Special settings have not been defined. Using previous configuration.');
    end
...
%% Add the script to combine all the CSV into one file for each measurement
